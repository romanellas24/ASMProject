...
Run `dotnet watch` for a dev server. Navigate to `http://localhost:5264/`. The application will automatically reload if you change any of the source files.
...
## Build With docker
Open a terminal in the "acmeat.apiuser/" folder and then run the following commands:
