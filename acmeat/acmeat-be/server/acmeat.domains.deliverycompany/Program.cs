...
using acmeat.domains.deliverycompany.Services;
...
builder.Services.AddScoped<DeliveryCompanyReader>();
builder.Services.AddScoped<DeliveryCompanyDataWriter>();
...
app.MapGrpcService<GrpcDeliveryCompanyManagerService>();
