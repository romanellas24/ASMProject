...
public static class Utils{
    ...
    public static db.deliveryCompany.DeliveryCompany ConvertServerElementIntoDbELement(DeliveryCompany deliverycompany){
        db.deliveryCompany.DeliveryCompany deliverycompanyDB = new db.deliveryCompany.DeliveryCompany(deliverycompany.Id, deliverycompany.Address, (int)deliverycompany.Price, deliverycompany.Available,deliverycompany.Name);
